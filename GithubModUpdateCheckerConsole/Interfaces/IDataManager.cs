...
namespace GithubModUpdateCheckerConsole.Interfaces
{
    public interface IDataManager
    {
        ...
        bool DetectMAModAndRemoveFromManagementForInitialize(ModAssistantModInformation item, KeyValuePair<string, Version> fileAndVersion, ref List<MAModInformationCsv> detectedModAssistantModCsvList, out bool loopBreak);
        ...
        bool DetectMAModAndRemoveFromManagementForUpdate(ModAssistantModInformation item, KeyValuePair<string, Version> fileAndVersion, List<string> installedMAMod);
